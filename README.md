...
|---|---|---|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **Taquiri, Giuseppe**<br>AV1: Desarrolló y documentó el diseño estratégico de la solución, trabajando en EventStorming, Candidate Context Discovery, Domain Message Flows Modeling, incorporando Domain Storytelling, Bounded Context Canvases con sus 6 pasos de elaboración y Context Mapping mediante las Opciones 1, 2 y 3.<br><br>**Lagos Rivera, Kael Valentino**<br>AV1: Participó en el desarrollo y documentación de los artefactos asignados al equipo, coordinando sus actividades con los demás integrantes y contribuyendo a la integración de los resultados en el informe del proyecto.<br><br>**Gonzalez Custodio, Carlos Alberto**<br>AV1: Participó en la elaboración y documentación de los artefactos correspondientes a la entrega, coordinando sus actividades con los integrantes del equipo y contribuyendo al avance conjunto del proyecto.<br><br>**Tasayco Almonacid, Rafael Augusto**<br>AV1: Participó en el desarrollo de los artefactos asignados para la entrega y coordinó sus actividades con los demás integrantes para integrar los resultados en una propuesta común.<br><br>**Tasayco Osorio, Raúl Hiroshi**<br>AV1: Participó en la elaboración de los artefactos del proyecto correspondientes a su responsabilidad, colaborando con los demás integrantes para cumplir las actividades planificadas para AV1.<br><br>**Inga Hernandez, Ayrton Damian**<br>AV1: Participó en las actividades de desarrollo y documentación del proyecto, coordinando sus aportes con los demás integrantes y contribuyendo al cumplimiento de los objetivos establecidos para la entrega.<br><br>**Huaman De La Cruz, Jean Pool**<br>AV1: Participó en la elaboración y documentación de los artefactos del proyecto, coordinando sus actividades con el equipo y contribuyendo a la integración de los diferentes aportes en el informe de AV1. | La participación conjunta de los integrantes permitió distribuir responsabilidades y desarrollar diferentes actividades del trabajo final. La coordinación entre los miembros permitió integrar los aportes individuales dentro de una estructura común y avanzar en la elaboración de los artefactos correspondientes a AV1. La participación en las actividades de análisis, diseño y documentación permitió establecer una base común para la evolución posterior de la solución IoT. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos.** | **Taquiri, Giuseppe**<br>AV1: Participó en la elaboración y documentación del diseño estratégico de la solución, contribuyendo al desarrollo de EventStorming, Domain Storytelling, Bounded Context Canvases y Context Mapping. Coordinó sus actividades con los integrantes del equipo para integrar los resultados en el informe.<br><br>**Lagos Rivera, Kael Valentino**<br>AV1: Participó en las actividades asignadas para AV1, coordinando avances con el equipo y contribuyendo a la elaboración e integración de los artefactos requeridos para la entrega.<br><br>**Gonzalez Custodio, Carlos Alberto**<br>AV1: Participó en las actividades planificadas para AV1 y colaboró con los integrantes del equipo en la elaboración, revisión e integración de los artefactos del proyecto.<br><br>**Tasayco Almonacid, Rafael Augusto**<br>AV1: Participó en las tareas asignadas para la entrega, manteniendo coordinación con los integrantes del equipo y contribuyendo al cumplimiento de los objetivos establecidos para AV1.<br><br>**Tasayco Osorio, Raúl Hiroshi**<br>AV1: Participó en las actividades de elaboración y revisión de los artefactos correspondientes a AV1, colaborando con el equipo para organizar y completar las tareas planificadas.<br><br>**Inga Hernandez, Ayrton Damian**<br>AV1: Participó en las actividades planificadas para la entrega, coordinando sus avances con el equipo y contribuyendo a la elaboración y revisión de los artefactos incluidos en el informe.<br><br>**Huaman De La Cruz, Jean Pool**<br>AV1: Participó en la elaboración y revisión de los artefactos correspondientes a AV1, coordinando sus actividades con el equipo y contribuyendo al cumplimiento de las tareas planificadas. | El trabajo realizado de manera colaborativa permitió organizar las actividades del equipo y contribuir al cumplimiento de los objetivos establecidos para AV1. La coordinación entre los integrantes facilitó la integración de los diferentes artefactos y permitió mantener una estructura común en el desarrollo del proyecto. Los aportes individuales se incorporaron progresivamente al informe y permitieron establecer una base para las siguientes etapas del ciclo de vida de SafeCore. |
